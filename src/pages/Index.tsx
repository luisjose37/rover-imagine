      ...
      <TerminalWindow className="max-w-6xl mx-auto">
        ...
        <div className="p-4 md:p-6 border-b border-primary/30">
          <div className="text-center overflow-hidden">
            {/* Mobile header - simplified text */}
            <div className="block md:hidden">
              <h1 className="text-primary text-glow font-terminal text-xl tracking-widest">
                ROVER.IMAGINE
              </h1>
              <p className="text-primary/70 font-terminal text-xs mt-1">
                NFT STORY GENERATOR
              </p>
            </div>
            {/* Desktop header - ASCII art */}
        ...
        {selectedNFT && !isLoadingNFT && <div className="flex flex-col">
            ...
            <div className="border-b border-primary/30 p-4 md:p-6">
              ...
              <div className="mb-4 md:mb-6">
                {/* NFT Image - Centered and responsive */}
                ...
                <div className="text-center">
                  <div className="text-primary text-glow font-terminal text-xl sm:text-2xl">
                    {selectedNFT.name}
                  </div>
                  <div className="text-muted-foreground font-terminal text-xs sm:text-sm mt-1">
                    TOKEN ID: {selectedNFT.identifier}
                  </div>
                  {selectedNFT.opensea_url && <a href={selectedNFT.opensea_url} target="_blank" rel="noopener noreferrer" className="text-primary/70 hover:text-primary font-terminal text-xs sm:text-sm underline mt-2 inline-block">
                      {">"} VIEW ON OPENSEA
                    </a>}
                </div>
              </div>
